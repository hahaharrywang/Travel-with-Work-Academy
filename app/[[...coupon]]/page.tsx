      ...
      <footer className="py-12 bg-[#17464F] text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-white/60 mb-6">會有專人回覆</p>

            {/* Decorative divider */}
            <div className="flex items-center justify-center gap-2 mb-6">
              <div className="w-1 h-1 rounded-full bg-[#D4B483]/40"></div>
              <div className="w-1 h-1 rounded-full bg-[#D4B483]/60"></div>
              <div className="w-1 h-1 rounded-full bg-[#D4B483]"></div>
              <div className="w-1 h-1 rounded-full bg-[#D4B483]/60"></div>
              <div className="w-1 h-1 rounded-full bg-[#D4B483]/40"></div>
            </div>
