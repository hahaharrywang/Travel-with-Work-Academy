  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogPortal>
        ...
        <DialogContent
          className="fixed left-[50%] top-[50%] z-50 flex flex-col w-[98vw] max-w-[98vw] sm:max-w-[1600px] max-h-[94vh] translate-x-[-50%] translate-y-[-50%] bg-brand-offwhite p-0 shadow-2xl rounded-2xl border border-brand-mist overflow-hidden"
